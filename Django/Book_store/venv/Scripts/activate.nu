...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'G:\Insync\GoogleDrive\Python programing learn\Python Django - The Practical Guide\Book_store\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'G:\Insync\GoogleDrive\Python programing learn\Python Django - The Practical Guide\Book_store\venv\Scripts\deactivate.nu'
