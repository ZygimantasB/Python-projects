...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'G:\Insync\GoogleDrive\Python programing learn\CodeAcademy_programavimas\_77_paskaita\game_roll_dice\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'G:\Insync\GoogleDrive\Python programing learn\CodeAcademy_programavimas\_77_paskaita\game_roll_dice\venv\Scripts\deactivate.nu'
